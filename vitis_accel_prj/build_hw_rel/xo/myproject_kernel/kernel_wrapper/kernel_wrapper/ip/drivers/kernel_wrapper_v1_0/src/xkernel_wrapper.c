...
void XKernel_wrapper_Continue(XKernel_wrapper *InstancePtr) {
    u32 Data;
    ...
    Data = XKernel_wrapper_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_AP_CTRL) & 0x80;
    XKernel_wrapper_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_AP_CTRL, Data | 0x10);
}
...
void XKernel_wrapper_Set_in_r(XKernel_wrapper *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKernel_wrapper_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_IN_R_DATA, (u32)(Data));
    XKernel_wrapper_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_IN_R_DATA + 4, (u32)(Data >> 32));
}

u64 XKernel_wrapper_Get_in_r(XKernel_wrapper *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKernel_wrapper_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_IN_R_DATA);
    Data += (u64)XKernel_wrapper_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_IN_R_DATA + 4) << 32;
    return Data;
}

void XKernel_wrapper_Set_out_r(XKernel_wrapper *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKernel_wrapper_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_OUT_R_DATA, (u32)(Data));
    XKernel_wrapper_WriteReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_OUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XKernel_wrapper_Get_out_r(XKernel_wrapper *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKernel_wrapper_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_OUT_R_DATA);
    Data += (u64)XKernel_wrapper_ReadReg(InstancePtr->Control_BaseAddress, XKERNEL_WRAPPER_CONTROL_ADDR_OUT_R_DATA + 4) << 32;
    return Data;
}
