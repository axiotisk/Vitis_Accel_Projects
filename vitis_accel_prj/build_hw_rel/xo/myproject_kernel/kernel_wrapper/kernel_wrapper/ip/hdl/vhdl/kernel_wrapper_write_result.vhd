...
attribute shreg_extract : string;
    ...
    signal tmp_3_reg_258 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln18_fu_204_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln18_reg_263 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_reg_268 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_reg_273 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_reg_278 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state75) and (m_axi_gmem1_BVALID = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                gmem1_addr_reg_283 <= sext_ln18_fu_248_p1;
                tmp_1_reg_273 <= output_r_dout(95 downto 64);
                tmp_2_reg_278 <= output_r_dout(127 downto 96);
                tmp_3_reg_258 <= output_r_dout(159 downto 128);
                tmp_s_reg_268 <= output_r_dout(63 downto 32);
                trunc_ln18_reg_263 <= trunc_ln18_fu_204_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_AWREADY, m_axi_gmem1_WREADY, m_axi_gmem1_BVALID, out_r_empty_n, output_r_empty_n, n_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, ap_CS_fsm_state75)
    begin
        case ap_CS_fsm is
    ...
    add_ln20_1_fu_180_p2 <= std_logic_vector(unsigned(p_shl_cast2_fu_164_p1) + unsigned(zext_ln20_fu_176_p1));
    add_ln20_fu_198_p2 <= std_logic_vector(unsigned(out_r_dout) + unsigned(zext_ln20_1_fu_194_p1));
    ...
    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem1_BVALID, ap_CS_fsm_state75)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (m_axi_gmem1_BVALID = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(m_axi_gmem1_BVALID, ap_CS_fsm_state75)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (m_axi_gmem1_BVALID = ap_const_logic_1))) then 
    ...
    gmem1_blk_n_W_assign_proc : process(m_axi_gmem1_WREADY, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7)
    begin
    ...
    m_axi_gmem1_AWADDR <= gmem1_addr_reg_283;
    ...
    m_axi_gmem1_BREADY_assign_proc : process(m_axi_gmem1_BVALID, ap_CS_fsm_state75)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (m_axi_gmem1_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_WDATA_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, tmp_3_reg_258, trunc_ln18_reg_263, tmp_s_reg_268, tmp_1_reg_273, tmp_2_reg_278)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            m_axi_gmem1_WDATA <= tmp_3_reg_258;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            m_axi_gmem1_WDATA <= tmp_2_reg_278;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            m_axi_gmem1_WDATA <= tmp_1_reg_273;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            m_axi_gmem1_WDATA <= tmp_s_reg_268;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            m_axi_gmem1_WDATA <= trunc_ln18_reg_263;
        else 
    ...
    m_axi_gmem1_WVALID_assign_proc : process(m_axi_gmem1_WREADY, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state7) and (m_axi_gmem1_WREADY = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state6) and (m_axi_gmem1_WREADY = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state5) and (m_axi_gmem1_WREADY = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state4) and (m_axi_gmem1_WREADY = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state3) and (m_axi_gmem1_WREADY = ap_const_logic_1)))) then 
    ...
    shl_ln_fu_186_p3 <= (add_ln20_1_fu_180_p2 & ap_const_lv1_0);
