...
architecture behav of kernel_wrapper is 
    ...
    "kernel_wrapper_kernel_wrapper,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvc1902-vsvd1760-2MP-e-S,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.650000,HLS_SYN_LAT=114859,HLS_SYN_TPT=81995,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=42170,HLS_SYN_LUT=653062,HLS_VERSION=2022_2}";
