    ...
    reg ap_done_reg_2;// for module run_inference_U0.dataflow_in_loop_VITIS_LOOP_15_1_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_2 <= 'b0;
        end
        else begin
            ap_done_reg_2 <= run_inference_U0.dataflow_in_loop_VITIS_LOOP_15_1_U0.ap_done & ~run_inference_U0.dataflow_in_loop_VITIS_LOOP_15_1_U0.ap_continue;
        end
    end

    reg ap_done_reg_3;// for module run_inference_U0.dataflow_in_loop_VITIS_LOOP_15_1_U0.myproject_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= run_inference_U0.dataflow_in_loop_VITIS_LOOP_15_1_U0.myproject_U0.ap_done & ~run_inference_U0.dataflow_in_loop_VITIS_LOOP_15_1_U0.myproject_U0.ap_continue;
        end
    end
