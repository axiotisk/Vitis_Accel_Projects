...
module kernel_wrapper_dataflow_in_loop_VITIS_LOOP_36_1 (
        m_axi_gmem0_AWVALID,
        m_axi_gmem0_AWREADY,
        m_axi_gmem0_AWADDR,
        m_axi_gmem0_AWID,
...
wire   [15:0] read_input_U0_m_axi_gmem0_WDATA;
wire   [1:0] read_input_U0_m_axi_gmem0_WSTRB;
...
wire    myproject_U0_output_r_write;
...
wire    write_result_U0_output_r_read;
wire    write_result_U0_n_read;
wire    out_r_c_full_n;
...
wire    input1_full_n;
wire   [47:0] input1_dout;
wire   [10:0] input1_num_data_valid;
...
wire    n_c_empty_n;
wire    output2_full_n;
wire   [159:0] output2_dout;
wire   [1:0] output2_num_data_valid;
wire   [1:0] output2_fifo_cap;
...
kernel_wrapper_fifo_w48_d1024_A input1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kernel_wrapper_fifo_w160_d1_S_x output2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kernel_wrapper_start_for_write_result_U0 start_for_write_result_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kernel_wrapper_start_for_myproject_U0 start_for_myproject_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (write_result_U0_ap_idle & read_input_U0_ap_idle & myproject_U0_ap_idle & entry_proc_U0_ap_idle);
...
assign m_axi_gmem1_AWADDR = write_result_U0_m_axi_gmem1_AWADDR;

assign m_axi_gmem1_AWBURST = write_result_U0_m_axi_gmem1_AWBURST;

assign m_axi_gmem1_AWCACHE = write_result_U0_m_axi_gmem1_AWCACHE;

assign m_axi_gmem1_AWID = write_result_U0_m_axi_gmem1_AWID;

assign m_axi_gmem1_AWLEN = write_result_U0_m_axi_gmem1_AWLEN;

assign m_axi_gmem1_AWLOCK = write_result_U0_m_axi_gmem1_AWLOCK;

assign m_axi_gmem1_AWPROT = write_result_U0_m_axi_gmem1_AWPROT;

assign m_axi_gmem1_AWQOS = write_result_U0_m_axi_gmem1_AWQOS;

assign m_axi_gmem1_AWREGION = write_result_U0_m_axi_gmem1_AWREGION;

assign m_axi_gmem1_AWSIZE = write_result_U0_m_axi_gmem1_AWSIZE;

assign m_axi_gmem1_AWUSER = write_result_U0_m_axi_gmem1_AWUSER;

assign m_axi_gmem1_AWVALID = write_result_U0_m_axi_gmem1_AWVALID;

assign m_axi_gmem1_BREADY = write_result_U0_m_axi_gmem1_BREADY;

assign m_axi_gmem1_RREADY = 1'b0;

assign m_axi_gmem1_WDATA = write_result_U0_m_axi_gmem1_WDATA;

assign m_axi_gmem1_WID = write_result_U0_m_axi_gmem1_WID;

assign m_axi_gmem1_WLAST = write_result_U0_m_axi_gmem1_WLAST;

assign m_axi_gmem1_WSTRB = write_result_U0_m_axi_gmem1_WSTRB;

assign m_axi_gmem1_WUSER = write_result_U0_m_axi_gmem1_WUSER;

assign m_axi_gmem1_WVALID = write_result_U0_m_axi_gmem1_WVALID;
...
endmodule //kernel_wrapper_dataflow_in_loop_VITIS_LOOP_36_1
