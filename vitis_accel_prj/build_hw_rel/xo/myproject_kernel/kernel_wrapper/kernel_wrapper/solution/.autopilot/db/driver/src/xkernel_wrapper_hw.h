...
#define XKERNEL_WRAPPER_CONTROL_ADDR_IN_R_DATA  0x10
#define XKERNEL_WRAPPER_CONTROL_BITS_IN_R_DATA  64
#define XKERNEL_WRAPPER_CONTROL_ADDR_OUT_R_DATA 0x1c
#define XKERNEL_WRAPPER_CONTROL_BITS_OUT_R_DATA 64
