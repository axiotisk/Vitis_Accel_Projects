...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln5_1_i \
    op interface \
    ports { sext_ln5_1_i { I 63 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_input1 \
    op interface \
    ports { input1_din { O 48 vector } input1_num_data_valid { I 11 vector } input1_fifo_cap { I 11 vector } input1_full_n { I 1 bit } input1_write { O 1 bit } } \
} "
}
