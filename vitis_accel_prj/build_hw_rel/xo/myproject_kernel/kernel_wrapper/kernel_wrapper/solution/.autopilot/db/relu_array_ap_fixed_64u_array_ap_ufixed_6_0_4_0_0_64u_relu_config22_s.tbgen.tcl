...
set C_modelArgList {
	{ layer21_out int 1024 regular {fifo 0 volatile }  }
	{ layer22_out int 384 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer21_out", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer21_out_dout sc_in sc_lv 1024 signal 0 } 
	...
	{ layer22_out_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ layer22_out_fifo_cap sc_in sc_lv 2 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer21_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "layer21_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer21_out { ap_fifo {  { layer21_out_dout fifo_port_we 0 1024 }  { layer21_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer21_out_fifo_cap fifo_update 0 2 }  { layer21_out_empty_n fifo_status 0 1 }  { layer21_out_read fifo_data 1 1 } } }
	layer22_out { ap_fifo {  { layer22_out_din fifo_port_we 1 384 }  { layer22_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer22_out_fifo_cap fifo_update 0 2 }  { layer22_out_full_n fifo_status 0 1 }  { layer22_out_write fifo_data 1 1 } } }
}
