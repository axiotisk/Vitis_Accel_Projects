...
set C_modelArgList {
	...
	{ layer4_out int 96 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer4_out_din sc_out sc_lv 96 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer4_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "layer4_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer2_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "900", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer2_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer4_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "900", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_port_we 0 256 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer2_out_fifo_cap fifo_update 0 11 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_data 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_port_we 1 96 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer4_out_fifo_cap fifo_update 0 11 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_data 1 1 } } }
}
