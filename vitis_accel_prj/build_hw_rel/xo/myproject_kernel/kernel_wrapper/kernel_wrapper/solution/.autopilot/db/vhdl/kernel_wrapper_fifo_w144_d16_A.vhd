...
entity kernel_wrapper_fifo_w144_d16_A is
    generic (
...
architecture arch of kernel_wrapper_fifo_w144_d16_A is

    -- component
    component kernel_wrapper_fifo_w144_d16_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 144;
...
begin
----------------------- Instantiation -----------------------
    U_kernel_wrapper_fifo_w144_d16_A_ram : kernel_wrapper_fifo_w144_d16_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity kernel_wrapper_fifo_w144_d16_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 144;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of kernel_wrapper_fifo_w144_d16_A_ram is
