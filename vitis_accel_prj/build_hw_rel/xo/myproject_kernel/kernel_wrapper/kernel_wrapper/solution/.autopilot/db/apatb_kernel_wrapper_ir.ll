; ModuleID = '/home/ayvol/vitis-accel-hw-quant/vitis_accel_prj/build_hw_rel/xo/myproject_kernel/kernel_wrapper/kernel_wrapper/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_kernel_wrapper_ir(float* noalias nocapture nonnull readonly %in, float* noalias nocapture nonnull %out) local_unnamed_addr #0 {
entry:
  %in_copy = alloca float, align 512
  %out_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %in, float* nonnull align 512 %in_copy, float* nonnull %out, float* nonnull align 512 %out_copy)
  call void @apatb_kernel_wrapper_hw(float* %in_copy, float* %out_copy)
  call void @copy_back(float* %in, float* %in_copy, float* %out, float* %out_copy)
  ret void
}
...
declare void @apatb_kernel_wrapper_hw(float*, float*)
...
define void @kernel_wrapper_hw_stub_wrapper(float*, float*) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1)
  call void @kernel_wrapper_hw_stub(float* %0, float* %1)
  call void @copy_in(float* null, float* %0, float* null, float* %1)
  ret void
}

declare void @kernel_wrapper_hw_stub(float*, float*)
