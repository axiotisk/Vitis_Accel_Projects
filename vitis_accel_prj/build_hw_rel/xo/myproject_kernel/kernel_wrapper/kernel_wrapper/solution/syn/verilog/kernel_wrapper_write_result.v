...
reg    output_r_blk_n;
reg    n_blk_n;
reg   [31:0] tmp_3_reg_258;
wire   [31:0] trunc_ln18_fu_204_p1;
reg   [31:0] trunc_ln18_reg_263;
reg   [31:0] tmp_s_reg_268;
reg   [31:0] tmp_1_reg_273;
reg   [31:0] tmp_2_reg_278;
reg   [63:0] gmem1_addr_reg_283;
wire  signed [63:0] sext_ln18_fu_248_p1;
reg    ap_block_state1;
wire   [15:0] p_shl_fu_156_p3;
wire   [13:0] p_shl1_fu_168_p3;
wire   [16:0] p_shl_cast2_fu_164_p1;
wire   [16:0] zext_ln20_fu_176_p1;
wire   [16:0] add_ln20_1_fu_180_p2;
wire   [17:0] shl_ln_fu_186_p3;
wire   [63:0] zext_ln20_1_fu_194_p1;
wire   [63:0] add_ln20_fu_198_p2;
wire   [61:0] trunc_ln_fu_238_p4;
reg   [74:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state75) & (m_axi_gmem1_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        tmp_1_reg_273 <= {{output_r_dout[95:64]}};
        tmp_2_reg_278 <= {{output_r_dout[127:96]}};
        tmp_3_reg_258 <= {{output_r_dout[159:128]}};
        tmp_s_reg_268 <= {{output_r_dout[63:32]}};
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state7) & (m_axi_gmem1_WREADY == 1'b1)) | ((1'b1 == ap_CS_fsm_state6) & (m_axi_gmem1_WREADY == 1'b1)) | ((1'b1 == ap_CS_fsm_state5) & (m_axi_gmem1_WREADY == 1'b1)) | ((1'b1 == ap_CS_fsm_state4) & (m_axi_gmem1_WREADY == 1'b1)) | ((1'b1 == ap_CS_fsm_state3) & (m_axi_gmem1_WREADY == 1'b1)))) begin
...
assign add_ln20_1_fu_180_p2 = (p_shl_cast2_fu_164_p1 + zext_ln20_fu_176_p1);

assign add_ln20_fu_198_p2 = (out_r_dout + zext_ln20_1_fu_194_p1);
...
assign m_axi_gmem1_AWADDR = gmem1_addr_reg_283;
...
assign p_shl1_fu_168_p3 = {{n_dout}, {1'd0}};

assign p_shl_cast2_fu_164_p1 = p_shl_fu_156_p3;

assign p_shl_fu_156_p3 = {{n_dout}, {3'd0}};

assign sext_ln18_fu_248_p1 = $signed(trunc_ln_fu_238_p4);

assign shl_ln_fu_186_p3 = {{add_ln20_1_fu_180_p2}, {1'd0}};

assign trunc_ln18_fu_204_p1 = output_r_dout[31:0];

assign trunc_ln_fu_238_p4 = {{add_ln20_fu_198_p2[63:2]}};

assign zext_ln20_1_fu_194_p1 = shl_ln_fu_186_p3;

assign zext_ln20_fu_176_p1 = p_shl1_fu_168_p3;
