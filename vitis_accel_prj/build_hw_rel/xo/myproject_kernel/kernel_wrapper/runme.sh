...
HD_PWD='/home/ayvol/vitis-accel-hw-quant/vitis_accel_prj/build_hw_rel/xo/myproject_kernel/kernel_wrapper'
cd "$HD_PWD"
...
EAStep vitis_hls -f kernel_wrapper.tcl -messageDb vitis_hls.pb
