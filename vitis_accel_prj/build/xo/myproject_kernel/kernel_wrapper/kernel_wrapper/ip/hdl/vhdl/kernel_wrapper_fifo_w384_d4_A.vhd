...
entity kernel_wrapper_fifo_w384_d4_A is
    generic (
...
architecture arch of kernel_wrapper_fifo_w384_d4_A is

    -- component
    component kernel_wrapper_fifo_w384_d4_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_kernel_wrapper_fifo_w384_d4_A_ram : kernel_wrapper_fifo_w384_d4_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity kernel_wrapper_fifo_w384_d4_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 384;
        ADDR_WIDTH  : integer := 2;
...
architecture arch of kernel_wrapper_fifo_w384_d4_A_ram is
