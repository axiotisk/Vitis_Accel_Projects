...
set portList { 
	...
	{ input1_din sc_out sc_lv 48 signal 2 } 
	{ input1_num_data_valid sc_in sc_lv 11 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "input1", "role": "din" }} , 
 	{ "name": "input1_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "input1", "role": "num_data_valid" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3148", "EstimateLatencyMax" : "3148",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_input_Pipeline_VITIS_LOOP_5_1_fu_97", "Port" : "gmem0", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
			{"Name" : "in_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "input1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_input_Pipeline_VITIS_LOOP_5_1_fu_97", "Port" : "input1", "Inst_start_state" : "73", "Inst_end_state" : "74"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_input_Pipeline_VITIS_LOOP_5_1_fu_97", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "sext_ln5_1_i", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_input_Pipeline_VITIS_LOOP_5_1_fu_97.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	read_input_Pipeline_VITIS_LOOP_5_1 {
		gmem0 {Type I LastRead 3 FirstWrite -1}
		sext_ln5_1_i {Type I LastRead 0 FirstWrite -1}
		input1 {Type O LastRead -1 FirstWrite 4}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3148", "Max" : "3148"}
