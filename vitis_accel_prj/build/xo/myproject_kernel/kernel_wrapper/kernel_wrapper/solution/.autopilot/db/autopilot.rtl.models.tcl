set SynModuleInfo {
  ...
  {SRCNAME dataflow_in_loop_VITIS_LOOP_14_1 MODELNAME dataflow_in_loop_VITIS_LOOP_14_1 RTLNAME kernel_wrapper_dataflow_in_loop_VITIS_LOOP_14_1}
  {SRCNAME run_inference MODELNAME run_inference RTLNAME kernel_wrapper_run_inference}
  {SRCNAME write_result_Pipeline_VITIS_LOOP_20_1 MODELNAME write_result_Pipeline_VITIS_LOOP_20_1 RTLNAME kernel_wrapper_write_result_Pipeline_VITIS_LOOP_20_1}
  ...
  {SRCNAME kernel_wrapper MODELNAME kernel_wrapper RTLNAME kernel_wrapper IS_TOP 1
    SUBMODULES {
      {MODELNAME kernel_wrapper_in_buf_V_RAM_AUTO_2R1W_memcore RTLNAME kernel_wrapper_in_buf_V_RAM_AUTO_2R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 3 ALLOW_PRAGMA 1}
      {MODELNAME kernel_wrapper_in_buf_V_RAM_AUTO_2R1W RTLNAME kernel_wrapper_in_buf_V_RAM_AUTO_2R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 3 ALLOW_PRAGMA 1}
