    ...
    reg ap_done_reg_2;// for module run_inference_U0.dataflow_in_loop_VITIS_LOOP_14_1_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_2 <= 'b0;
        end
        else begin
            ap_done_reg_2 <= run_inference_U0.dataflow_in_loop_VITIS_LOOP_14_1_U0.ap_done & ~run_inference_U0.dataflow_in_loop_VITIS_LOOP_14_1_U0.ap_continue;
        end
    end

    reg ap_done_reg_3;// for module run_inference_U0.dataflow_in_loop_VITIS_LOOP_14_1_U0.myproject_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= run_inference_U0.dataflow_in_loop_VITIS_LOOP_14_1_U0.myproject_U0.ap_done & ~run_inference_U0.dataflow_in_loop_VITIS_LOOP_14_1_U0.myproject_U0.ap_continue;
        end
    end
    ...
    kernel_wrapper_hls_deadlock_detect_unit #(4, 0, 2, 2) kernel_wrapper_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    kernel_wrapper_hls_deadlock_detect_unit #(4, 1, 2, 2) kernel_wrapper_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    kernel_wrapper_hls_deadlock_detect_unit #(4, 2, 2, 2) kernel_wrapper_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    kernel_wrapper_hls_deadlock_detect_unit #(4, 3, 2, 2) kernel_wrapper_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
