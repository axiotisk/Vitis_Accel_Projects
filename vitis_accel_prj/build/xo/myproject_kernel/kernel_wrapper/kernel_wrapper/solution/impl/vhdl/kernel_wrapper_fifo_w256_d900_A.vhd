...
entity kernel_wrapper_fifo_w256_d900_A is
    generic (
...
architecture arch of kernel_wrapper_fifo_w256_d900_A is

    -- component
    component kernel_wrapper_fifo_w256_d900_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_kernel_wrapper_fifo_w256_d900_A_ram : kernel_wrapper_fifo_w256_d900_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity kernel_wrapper_fifo_w256_d900_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 256;
        ADDR_WIDTH  : integer := 10;
...
architecture arch of kernel_wrapper_fifo_w256_d900_A_ram is
