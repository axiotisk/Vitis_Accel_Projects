...
module kernel_wrapper_conv_2d_cl_array_ap_fixed_3u_array_ap_fixed_16_6_5_3_0_16u_config2_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
#0 grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_ap_start_reg = 1'b0;
end

kernel_wrapper_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone) & (icmp_ln79_reg_275 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp29) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage4_11001_ignoreCallOp28) & (1'b1 == ap_CS_fsm_pp0_stage4)) | ((1'b0 == ap_block_pp0_stage3_11001_ignoreCallOp27) & (1'b1 == ap_CS_fsm_pp0_stage3)) | ((1'b0 == ap_block_pp0_stage2_11001_ignoreCallOp26) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b0 == ap_block_pp0_stage1_11001_ignoreCallOp24) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (icmp_ln79_reg_275 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln79_reg_275 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        input_r_read = 1'b1;
    end else begin
        input_r_read = 1'b0;
    end
...
assign add_ln79_fu_231_p2 = (ap_sig_allocacmp_indvar_flatten_load + 11'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp29 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (ap_done_reg == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage1_11001 = (((grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_layer2_out_blk_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln79_reg_275 == 1'd0) & (input_r_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_11001_ignoreCallOp24 = ((icmp_ln79_reg_275 == 1'd0) & (input_r_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_layer2_out_blk_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln79_reg_275 == 1'd0) & (input_r_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_pp0_stage2_11001_ignoreCallOp26 = (ap_done_reg == 1'b1);
end
...
assign ap_block_pp0_stage3_11001_ignoreCallOp27 = ~(1'b1 == 1'b1);

assign ap_block_pp0_stage3_subdone = ~(1'b1 == 1'b1);

assign ap_block_pp0_stage4_11001_ignoreCallOp28 = ~(1'b1 == 1'b1);
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((icmp_ln79_reg_275 == 1'd0) & (input_r_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_ignore_call8 = ((icmp_ln79_reg_275 == 1'd0) & (input_r_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state7_pp0_stage1_iter1 = (grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_layer2_out_blk_n == 1'b0);
end

assign ap_block_state7_pp0_stage1_iter1_ignore_call8 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_condition_475 = ((1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln79_reg_275 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1));
end

always @ (*) begin
    ap_condition_479 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_ap_start = grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_ap_start_reg;

assign grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_p_read = input_r_dout[15:0];

assign grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_p_read1 = {{input_r_dout[31:16]}};

assign grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_p_read2 = {{input_r_dout[47:32]}};

assign icmp_ln79_fu_225_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 11'd1024) ? 1'b1 : 1'b0);

assign layer2_out_din = grp_compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_16u_config2_s_fu_134_layer2_out_din;

assign start_out = real_start;

endmodule //kernel_wrapper_conv_2d_cl_array_ap_fixed_3u_array_ap_fixed_16_6_5_3_0_16u_config2_s
